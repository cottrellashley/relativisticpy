...
def indices_from_string(index_cls, indices_cls, string_arg):
    ...
    def r1_deserialiser(arg: str): return indices_cls(*[index_cls(symbol = _r1symbol(i), covariant=_r1covariant(i), values=int(_r1values(i)) if not _r1running(i) else None) for i in _r1split(arg)]) if _isr1(arg) else None
