...
// Constructor
Lexer* Lexer_new(struct TokenProvider* p_token_provider) 
{
...
void Lexer_tokenize(Lexer* p_lexer, struct Iterator* p_characters) 
{
...
void Lexer_number(Lexer* p_lexer) 
{
    ...
    while (Iterator_Current(p_lexer->p_characters) != NULL && (Characters_isDigit(Iterator_Current(p_lexer->p_characters)) || *Iterator_Current(p_lexer->p_characters) == '.')) 
    {
