...
class RelPyAstNodeTraverser:
    ...
    def limit(self, node: AstNode): return smp.limit(node.args[0], node.args[1], node.args[2])
    def expand(self, node: AstNode): return smp.expand(node.args[0])
    def diff(self, node: AstNode): return smp.diff(node.args[0], node.args[1])
    ...
    def dsolve(self, node: AstNode): return smp.dsolve(node.args[0], node.args[1]).rhs

    # Sympy Trigs
    def sin(self, node: AstNode): return smp.sin(node.args[0])
    def cos(self, node: AstNode): return smp.cos(node.args[0])
    def tan(self, node: AstNode): return smp.tan(node.args[0])
    def asin(self, node: AstNode): return smp.asin(node.args[0])
    def acos(self, node: AstNode): return smp.acos(node.args[0])
    def atan(self, node: AstNode): return smp.atan(node.args[0])
    def sinh(self, node: AstNode): return smp.sinh(node.args[0])
    def cosh(self, node: AstNode): return smp.cosh(node.args[0])
    def tanh(self, node: AstNode): return smp.tanh(node.args[0])
    def asinh(self, node: AstNode): return smp.asinh(node.args[0])
    def acosh(self, node: AstNode): return smp.acosh(node.args[0])
    def atanh(self, node: AstNode): return smp.atanh(node.args[0])
    ...
    def function(self, node: AstNode): return smp.symbols('{}'.format(node.handler), cls=smp.Function)(*node.args)
